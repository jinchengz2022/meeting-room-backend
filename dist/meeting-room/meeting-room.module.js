...
const meeting_room_controller_1 = require("./meeting-room.controller");
const typeorm_1 = require("@nestjs/typeorm");
const meeting_room_entity_1 = require("./entities/meeting-room.entity");
let MeetingRoomModule = class MeetingRoomModule {
};
exports.MeetingRoomModule = MeetingRoomModule;
exports.MeetingRoomModule = MeetingRoomModule = __decorate([
    (0, common_1.Module)({
        controllers: [meeting_room_controller_1.MeetingRoomController],
        providers: [meeting_room_service_1.MeetingRoomService],
        imports: [
            typeorm_1.TypeOrmModule.forFeature([meeting_room_entity_1.MeetingRoom])
        ]
    })
], MeetingRoomModule);
