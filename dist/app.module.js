...
const index_1 = require("./user/entities/index");
            ...
            typeorm_1.TypeOrmModule.forRootAsync({
                useFactory(configService) {
                    return {
                        ...
                        synchronize: true,
                        logging: true,
                        entities: [index_1.Permission, index_1.User, index_1.Role, meeting_room_entity_1.MeetingRoom, booking_entity_1.Booking],
                        poolSize: 10,
